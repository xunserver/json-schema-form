...
import type { ArrayItemId, DataNodeId, ViewNodeId } from "../../model/identity/index.js";
import type { InstancePath, InstancePathLike, ModelPath, ModelPathLike } from "../../model/path/types.js";
...
export interface FormEngine {
  ...
  create(
    ...
    options?: { readonly initialValues?: unknown; readonly valueInitializer?: string },
  ): FormInstance;
}
