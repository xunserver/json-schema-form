...
export class RendererEnvironmentBuildError extends Error {
  ...
  constructor(diagnostics: readonly Diagnostic[], message = "Vue renderer environment build failed") {
    super(message);
...
export class RendererCapabilityError extends Error {
  ...
  constructor(diagnostics: readonly Diagnostic[], message = "Vue renderer capability preflight failed") {
    super(message);
