...
const SCENARIOS: readonly { spec: string; scenario: string; files: readonly string[] }[] = [
  {
    ...
    files: ["packages/core/src/runtime/array/array-identity.test.ts"],
  },
  {
    spec: "array-identity-and-scopes",
  ...
  },
  {
    ...
    files: ["packages/core/src/runtime/array/array-identity.test.ts", "tests/runtime/array-e2e.test.ts"],
  },
  {
    spec: "array-identity-and-scopes",
    scenario: "按需访问递归实例",
  ...
  },
  {
    ...
    files: ["packages/core/src/runtime/array/array-identity.test.ts", "packages/core/src/runtime/form/create-form.test.ts"],
  },
  {
    spec: "array-identity-and-scopes",
  ...
  },
  {
    spec: "array-identity-and-scopes",
    scenario: "非法引用没有部分修改",
    files: ["packages/core/src/runtime/array/array-identity.test.ts", "packages/core/src/runtime/array/array-diagnostics.test.ts"],
  },
  {
    spec: "array-identity-and-scopes",
  ...
  },
  {
    ...
    files: ["packages/core/src/runtime/array/array-identity.test.ts", "packages/core/type-tests/array-instance.ts"],
  },
  {
    spec: "array-identity-and-scopes",
  ...
  },
  {
    ...
    files: ["packages/core/type-tests/array-instance.ts", "packages/core/src/runtime/array/array-identity.test.ts"],
  },
  {
    spec: "array-identity-and-scopes",
