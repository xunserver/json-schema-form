...
const SCENARIOS: readonly { spec: string; scenario: string; files: readonly string[] }[] = [
  ...
  },
  {
    ...
    files: ["packages/core/src/runtime/state/view-interaction.test.ts"],
  },
  {
    spec: "transactional-form-runtime",
  ...
  },
  {
    ...
    files: ["packages/core/src/runtime/state/view-interaction.test.ts", "packages/core/src/runtime/transaction/commands.test.ts"],
  },
  {
    spec: "transactional-form-runtime",
    scenario: "拒绝隐式创建数组项",
  ...
  },
  {
    ...
    files: ["packages/core/src/runtime/state/view-interaction.test.ts", "packages/core/type-tests/form-instance.ts"],
  },
  {
    spec: "transactional-form-runtime",
  ...
  },
  {
    ...
    files: ["packages/core/src/runtime/scope/render-scope.test.ts", "packages/core/src/runtime/array/array-identity.test.ts"],
  },
  {
    spec: "array-identity-and-scopes",
    scenario: "current-binding snapshot 是完整 InstanceBinding",
    files: ["packages/core/src/runtime/scope/render-scope.test.ts", "packages/core/type-tests/render-scope.ts"],
  },
  {
    spec: "array-identity-and-scopes",
  ...
  },
  {
    ...
    files: ["packages/core/src/runtime/scope/render-scope.test.ts"],
  },
  {
    spec: "array-identity-and-scopes",
  ...
  },
  {
    ...
    files: ["packages/core/src/runtime/state/required-effective.test.ts"],
  },
  {
    spec: "rules-and-schema-dynamics",
  ...
  },
  {
    ...
    files: ["packages/core/src/runtime/state/required-effective.test.ts", "packages/core/src/runtime/activation-serialize.test.ts"],
  },
];
