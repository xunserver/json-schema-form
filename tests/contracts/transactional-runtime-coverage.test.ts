...
const SCENARIOS: readonly { spec: string; scenario: string; files: readonly string[] }[] = [
  ...
  },
  {
    ...
    files: ["packages/core/src/runtime/form/create-form.test.ts", "tests/runtime/e2e.test.ts"],
  },
  {
    spec: "transactional-form-runtime",
    scenario: "拒绝不同 Environment 的 Model",
    files: ["packages/core/src/runtime/state/runtime-state.test.ts", "packages/core/src/runtime/form/create-form.test.ts"],
  },
  {
    spec: "transactional-form-runtime",
  ...
  },
  {
    ...
    files: ["packages/core/src/runtime/form/create-form.test.ts"],
  },
  {
    spec: "transactional-form-runtime",
  ...
  },
  {
    ...
    files: ["packages/core/src/runtime/state/runtime-state.test.ts", "packages/core/type-tests/form-instance.ts"],
  },
  {
    spec: "transactional-form-runtime",
  ...
  },
  {
    ...
    files: ["packages/core/src/runtime/transaction/commands.test.ts"],
  },
  {
    spec: "transactional-form-runtime",
  ...
  },
  {
    spec: "transactional-form-runtime",
    scenario: "拒绝隐式创建数组项",
    files: ["packages/core/src/runtime/form/create-form.test.ts", "packages/core/src/runtime/scope/instance-path.test.ts"],
  },
  {
    spec: "transactional-form-runtime",
    scenario: "value 往返后 dirty 恢复",
    files: ["packages/core/src/runtime/state/runtime-state.test.ts"],
  },
  {
    spec: "transactional-form-runtime",
  ...
  },
  {
    ...
    files: ["packages/core/src/runtime/form/create-form.test.ts", "packages/core/src/runtime/transaction/phases.test.ts"],
  },
  {
    spec: "transactional-form-runtime",
    scenario: "失败 transaction 完全回滚外部观察",
    files: ["packages/core/src/runtime/transaction/commands.test.ts", "packages/core/src/runtime/transaction/phases.test.ts"],
  },
  {
    spec: "transactional-form-runtime",
    scenario: "一次 transaction 只增加一个版本",
    files: ["packages/core/src/runtime/transaction/phases.test.ts"],
  },
  {
    spec: "transactional-form-runtime",
    scenario: "重复设置相同值",
  ...
  },
  {
    ...
    files: ["packages/core/src/runtime/subscription/selectors.test.ts", "packages/core/src/runtime/perf.test.ts"],
  },
  {
    spec: "transactional-form-runtime",
    scenario: "依赖变化但选择结果不变",
    files: ["packages/core/src/runtime/subscription/selectors.test.ts"],
  },
  {
    spec: "transactional-form-runtime",
    scenario: "取消订阅后不再通知",
  ...
  },
  {
    ...
    files: ["packages/core/src/runtime/transaction/phases.test.ts", "packages/core/type-tests/runtime-selectors.ts"],
  },
];
