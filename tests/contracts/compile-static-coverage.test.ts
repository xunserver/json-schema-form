...
const SCENARIOS: readonly { spec: string; scenario: string; files: readonly string[] }[] = [
  ...
  },
  {
    ...
    files: ["packages/core/src/compiler/data/data-model.test.ts", "tests/compile/e2e.test.ts"],
  },
  {
    spec: "core-public-contracts",
    scenario: "拒绝修改已编译 Model",
    files: [
      "packages/core/src/compiler/data/data-model.test.ts",
  ...
  },
  {
    ...
    files: ["packages/core/src/compiler/data/data-model.test.ts", "packages/core/type-tests/model.ts"],
  },
  {
    spec: "core-public-contracts",
  ...
  },
  {
    ...
    files: ["packages/core/src/compiler/compile-form.test.ts", "packages/core/src/compiler/ui/ui-model.test.ts"],
  },
  {
  ...
  },
  {
    ...
    files: ["packages/core/src/compiler/schema/frontend.test.ts", "packages/core/src/compiler/data/data-model.test.ts"],
  },
  {
    spec: "schema-frontend-and-shape-analysis",
  ...
  },
  {
    ...
    files: ["packages/core/src/compiler/data/data-model.test.ts", "packages/core/type-tests/identity.ts"],
  },
  {
    spec: "static-data-model",
    scenario: "编译 required property",
    files: ["packages/core/src/compiler/data/data-model.test.ts"],
  },
  {
    spec: "static-data-model",
  ...
  },
  {
    ...
    files: ["packages/core/src/compiler/ui/ui-model.test.ts", "tests/compile/e2e.test.ts"],
  },
  {
    spec: "static-ui-model",
  ...
  },
  {
    ...
    files: ["packages/core/src/compiler/ui/ui-model.test.ts", "packages/core/type-tests/data-ui-boundaries.ts"],
  },
  {
    spec: "static-ui-model",
  ...
  },
  {
    ...
    files: [
      "packages/core/src/widget/define-widget.test.ts",
  ...
  },
  {
    ...
    files: ["packages/core/src/widget/define-widget.test.ts"],
  },
  {
    spec: "core-plugin-environment",
  ...
  },
  {
    ...
    files: [
      "packages/core/src/compiler/ui/ui-model.test.ts",
      "packages/core/type-tests/define-widget.ts",
